function [ test ] = test_voisin_cell_morte(M, i, j)
% Ici on va tester les voisins de la cellule morte(i,j)
% si la cellule i,j admet exactement 3 voisins, alors la fonction retourne 1 
% , sinon 0

% cellule vivante vaut 1 , 0 sinon
